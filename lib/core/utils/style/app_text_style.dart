...
class AppTextStyle {
  static TextStyle font12ColorMainBlueRegular = TextStyle(
    fontSize: 12.sp,
  ...
  static const TextStyle font12ColorGreyW400 =
      TextStyle(fontSize: 12, fontWeight: FontWeight.w400, color: Colors.grey);
  static const TextStyle font14ColorBlackMeduim = TextStyle(
      fontSize: 14, color: Color(0xff242424), fontWeight: FontWeight.w500);
}
